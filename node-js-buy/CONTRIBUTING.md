...
our [Code of Conduct](https://github.com/Shopify/node-js-buy/blob/master/CODE_OF_CONDUCT.md).
...
```
git clone git@github.com:your-username/node-js-buy.git
```
...
## Examples
See [here](https://github.com/Shopify/node-js-buy/blob/master/examples) for our examples.
